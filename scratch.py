...
print(df[(df['split'] == 0) & (df['target'] == 0) & (df['confounder'] == 1)].shape[0])
print(df[(df['split'] == 0) & (df['target'] == 0) & (df['C1'] == 1)].shape[0])
...
print(df[(df['split'] == 0) & (df['target'] == 1) & (df['confounder'] == 1)].shape[0])
print(df[(df['split'] == 0) & (df['target'] == 1) & (df['C1'] == 1)].shape[0])
